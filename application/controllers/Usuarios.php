...
class Usuarios extends CI_Controller {
    ...
    public function index() {
        $data = array(
            ...
            'perfil_usuario' => $this->ion_auth->groups()->result(),
    ...
    public function add() {
        ...
        $this->form_validation->set_rules('company', '', 'required|min_length[5]|max_length[60]');
        $this->form_validation->set_rules('phone', '', 'length[14]');
        $this->form_validation->set_rules('cell_phone', '', 'length[15]');
    ...
    public function edit($usuario_id = NULL) {
        ...
        if (!$usuario_id || !$this->ion_auth->user($usuario_id)->row()) {
            ...
            if ($this->form_validation->run()) {
                ...
                $usuario = $this->core_model->get_by_id('users', array('$user_id' => $user_id));

                $data = array(
                    'titulo' => 'Atualizar cadastro do usuário '.$user->first_name,
    ...
    public function del($usuario_id = NULL) {
        ...
        if ($this->ion_auth->is_admin($usuario_id)) {
            ...
            $this->session->set_flashdata('error', 'O administrador não pode ser deletado!');
            redirect('usuarios');
        }
        ...
        if ($this->ion_auth->delete_user($usuario_id)) {
            ...
            $this->session->set_flashdata('error', 'Usuário não pode ser deletado!');
            redirect('usuarios');
        }
    }
