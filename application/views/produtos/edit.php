                ...
                <form class="user" method="POST" name="form_edit">
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-3 mb-2">
                                ...
                                <input type="text" class="form-control form-control-user" name="produto_codigo_barras" placeholder="Código de Barra" value="<?php echo $produto->produto_codigo_barras; ?>" readonly="">
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-3 mb-2">
                                ...
                                <input type="text" class="form-control form-control-user" name="produto_estoque_minimo" value="<?php echo $produto->produto_estoque_minimo; ?>">
                                <?php echo form_error('produto_estoque_minimo', '<small class="form-text text-danger">', '</small>'); ?>
                            </div>
                            <div class="col-md-3 mb-2">
                                <label>Valor de Compra</label>
                                <input type="text" class="form-control form-control-user money" name="produto_preco_custo" placeholder="Valor de Compra" value="<?php echo $produto->produto_preco_custo; ?>">
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form_goup row mb-3">
                            ...
                            <div class="col-md-4 mb-2">
                                <label>NCM</label>
                                <input type="text" class="form-control form-control-user" name="produto_ncm" placeholder="Código de NCM" value="<?php echo $produto->produto_ncm; ?>">
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <textarea type="text" class="form-control form-control-user" name="produto_obs" placeholder="Descrição "><?php echo $produto->produto_obs; ?></textarea>
