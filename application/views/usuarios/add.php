            ...
            <div class="card-body">
                ...
                <form class="user" method="POST" name="form_add">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <label>Empresa</label>
                            <input type="text" class="form-control form-control-user" name="company" placeholder="Sua empresa" value="<?php echo set_value('company'); ?>">
                            <?php echo form_error('company', '<small class="form-text text-danger">', '</small>'); ?>
                        </div>

                        <div class="col-md-4">
                            <label>Telefone</label>
                            <input type="text" class="form-control form-control-user sp_celphones" name="phone" placeholder="Seu telefone" value="<?php echo set_value('phone'); ?>">
                            <?php echo form_error('phone', '<small class="form-text text-danger">', '</small>'); ?>
                        </div>

                        <div class="col-md-4">
                            <label>Celular</label>
                            <input type="text" class="form-control form-control-user sp_celphones" name="cell_phone" placeholder="Seu celular" value="<?php echo set_value('cell_phone'); ?>">
