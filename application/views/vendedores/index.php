                                ...
                                <?php foreach ($vendedores as $vendedor): ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a title="Editar" href="<?php echo base_url('vendedores/edit/' . $vendedor->vendedor_id) ?>" class="btn btn-sm btn btn-outline-warning"><i class="fas fa-edit"></i></a>
                                            <a title="Excluir" href="javascript(void)" data-toggle="modal" data-target="#vendedor<?php echo $vendedor->vendedor_id; ?>" class="btn btn-sm btn btn-outline-danger"><i class="fas fa-trash-alt"></i></i></a>
                                        </td>
                                    </tr>
