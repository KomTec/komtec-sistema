        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                ...
                <form class="user" method="POST" name="form_edit">
                    ...
                    <p><strong><i class="fas fa-clock">&nbsp; &nbsp; Última atualização: </i>&nbsp;</strong><?php echo formata_data_banco_com_hora($conta_receber->conta_receber_data_alteracao) ?></p>
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-2 mb-2">
                                <label>Valor</label>
                                <input type="text" class="form-control form-control-user-date money" name="conta_receber_valor" value="<?php echo $conta_receber->conta_receber_valor; ?>" >
                            ...
                            <div class="col-md-2 mb-2">
                                ...
                                <select class="custom-select" name="conta_receber_status">
                                    <option value="1" <?php echo ($conta_receber->conta_receber_status == 1 ? 'selected' : '') ?>>Pago</option>
                        ...
                        <div class="form-group row mb-3">                            
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <textarea type="text" class="form-control form-control-user" name="conta_receber_obs"><?php echo $conta_receber->conta_receber_obs; ?></textarea>
                    ...
                    <button title="Salvar" type="submit" class="btn btn-outline-success btn-sm" <?php echo ($conta_receber->conta_receber_status == 1 ? 'disabled' : '') ?> ><?php echo ($conta_receber->conta_receber_status == 1 ? 'Conta Paga' : 'Receber') ?></button>
