                                ...
                                <?php foreach ($fornecedores as $fornecedor): ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a title="Editar" href="<?php echo base_url('fornecedores/edit/' . $fornecedor->fornecedor_id) ?>" class="btn btn-sm btn btn-outline-warning"><i class="fas fa-user-edit"></i></a>
                                            <a title="Excluir" href="javascript(void)" data-toggle="modal" data-target="#fornecedor<?php echo $fornecedor->fornecedor_id; ?>" class="btn btn-sm btn btn-outline-danger"><i class="fas fa-user-times"></i></a>
                                        </td>
                                    </tr>
