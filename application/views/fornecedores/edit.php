                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" class="form-control form-control-user-date" name="fornecedor_nome_fantasia" placeholder="Nome Fantasia " value="<?php echo $fornecedor->fornecedor_nome_fantasia; ?>">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input type="text" class="form-control form-control-user-date ie" name="fornecedor_ie" placeholder="Insc. Estadual " value="<?php echo $fornecedor->fornecedor_ie; ?>">
                                <?php echo form_error('fornecedor_ie', '<small class="form-text text-danger">', '</small>'); ?>
                            </div>
                            <div class="col-md-4 mb-2">
                                <label>Telefone Fixo</label>
                                <input type="text" class="form-control form-control-user sp_celphones" name="fornecedor_telefone" placeholder="Telefone " value="<?php echo $fornecedor->fornecedor_telefone; ?>">
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-5 mb-2">
                                ...
                                <input type="text" class="form-control form-control-user-date" name="fornecedor_endereco" placeholder="Logradouro " value="<?php echo $fornecedor->fornecedor_endereco; ?>">
                                <?php echo form_error('fornecedor_numero_endereco', '<small class="form-text text-danger">', '</small>'); ?>
                            </div>
                            <div class="col-md-1 mb-2">
                                <label>Número</label>
                                <input type="text" class="form-control form-control-user-date" name="fornecedor_numero_endereco" placeholder=" " value="<?php echo $fornecedor->fornecedor_numero_endereco; ?>">
                                <?php echo form_error('fornecedor_numero_endereco', '<small class="form-text text-danger">', '</small>'); ?>
                            </div>
                            <div class="col-md-4 mb-2">
                                <label>Complemento</label>
                                <input type="text" class="form-control form-control-user-date" name="fornecedor_complemento" placeholder="Complemento " value="<?php echo $fornecedor->fornecedor_complemento; ?>">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-1 mb-2">
                                <label>UF</label>
                                <input type="text" class="form-control form-control-user-date" name="fornecedor_estado" placeholder="UF " value="<?php echo $fornecedor->fornecedor_estado; ?>">
