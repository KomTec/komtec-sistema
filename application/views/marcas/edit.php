        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                ...
                <form class="user" method="POST" name="form_edit">
                    ...
                    <p><strong><i class="fas fa-clock">&nbsp; &nbsp; Última atualização: </i>&nbsp;</strong><?php echo formata_data_banco_com_hora($marca->marca_data_alteracao) ?></p>
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input type="text" class="form-control form-control-user" name="marca_nome" placeholder="Nome do serviço" value="<?php echo $marca->marca_nome; ?>">
