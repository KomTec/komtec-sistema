                                ...
                                <?php foreach ($marcas as $marca): ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a title="Editar" href="<?php echo base_url('marcas/edit/' . $marca->marca_id) ?>" class="btn btn-sm btn btn-outline-warning"><i class="fas fa-edit"></i></a>
                                            <a title="Excluir" href="javascript(void)" data-toggle="modal" data-target="#marca<?php echo $marca->marca_id; ?>" class="btn btn-sm btn btn-outline-danger"><i class="fas fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
