                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-3 mb-2">
                                ...
                                <input type="date" class="form-control form-control-user-date" name="conta_pagar_data_vencimento" value="<?php echo set_select('conta_pagar_data_vencimento'); ?>">
                                <?php echo form_error('conta_pagar_data_vencimento', '<small class="form-text text-danger">', '</small>'); ?>
                            </div>

                            <div class="col-md-2 mb-2">
                                <label>Valor</label>
                                <input type="text" class="form-control form-control-user-date money2" name="conta_pagar_valor" value="<?php echo set_select('conta_pagar_valor'); ?>" >
                        ...
                        <div class="form-group row mb-3">                            
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <textarea type="text" class="form-control form-control-user" name="conta_pagar_obs"><?php echo set_select('conta_pagar_obs'); ?></textarea>
