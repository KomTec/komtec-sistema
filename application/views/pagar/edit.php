        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                ...
                <form class="user" method="POST" name="form_edit">
                    ...
                    <p><strong><i class="fas fa-clock">&nbsp; &nbsp; Última atualização: </i>&nbsp;</strong><?php echo formata_data_banco_com_hora($conta_pagar->conta_pagar_data_alteracao) ?></p>
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row mb-3">                            
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <textarea type="text" class="form-control form-control-user" name="conta_pagar_obs"><?php echo $conta_pagar->conta_pagar_obs; ?></textarea>
                    ...
                    <button title="Salvar" type="submit" class="btn btn-outline-success btn-sm" <?php echo ($conta_pagar->conta_pagar_status == 1 ? 'disabled' : '') ?> ><?php echo ($conta_pagar->conta_pagar_status == 1 ? 'Conta Paga' : 'Pagar') ?></button>
