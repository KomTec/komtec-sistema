              ...
              <div class="col-lg-12">
                ...
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4"><strong>Sistema de Gestão KomTec</strong></h1>
                  </div>
                  ...
                  <form class="user" name="form_auth" method="POST" action="<?php echo base_url('login/auth') ?>">
                    ...
                    <button type="submit" class="btn btn-outline-primary btn-user btn-block" >Entrar</button>
                  </form>
                </div>
              </div>
            </div>
