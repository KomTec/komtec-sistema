                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input type="text" class="form-control form-control-user" name="servico_descricao" placeholder="Nome do serviço" value="<?php echo $servico->servico_descricao; ?>">
                        ...
                        <div class="form_goup row mb-3">
                            <div class="col-md-12 mb-2">
                                ...
                                <textarea type="text" class="form-control form-control-user" name="servico_nome" placeholder="Descrição " style="min-height: 100px!important"><?php echo $servico->servico_nome; ?></textarea>
