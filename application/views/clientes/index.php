...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h2><a title="Cadastrar Cliente" href="<?php echo base_url('clientes/add'); ?>" class="btn btn-outline-success btn-sm float-lg-right"><i class="fas fa-user-tie"></i>&nbsp; Novo</a>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                <?php foreach ($clientes as $cliente): ?>
                                    <tr>
                                        ...
                                        <td class="text-center pr-4"><?php echo ($cliente->cliente_tipo == 1 ? 'Pessoa Física' : 'Pessoa Jurídica') ?></td>
                                        <td class="text-center sp_celphones"><?php echo $cliente->cliente_celular ?></td>
                                        <td class="text-center"><?php echo $cliente->cliente_email ?></td>
                                        <td class="text-center"><?php echo $cliente->cliente_data_cadastro ?></td>                    
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a class="btn btn-success btn-sm" href="<?php echo base_url('clientes/del/' . $cliente->cliente_id) ?>">Sim</a>
                                            </div>
                                        </div>
                                    </div>
                                </div> 
