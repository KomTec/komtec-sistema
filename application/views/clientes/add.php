        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                ...
                <form class="user" method="POST" name="form_add">
                    ...
                    <fieldset class="mt-4 border p-4">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-5 mb-2">
                                ...
                                <input type="text" class="form-control form-control-user-date" name="cliente_sobrenome" placeholder="Sobrenome do Cliente" value="<?php echo set_value('cliente_sobreome'); ?>">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-2 mb-2">						
                                ...
                                <label class="pessoa_juridica">Inc. Estadual</label>
                            ...
                            <div class="col-md-2 mb-2">
                                ...
                                <input type="text" class="form-control form-control-user sp_celphones" name="cliente_telefone" placeholder="Telefone do cliente " value="<?php echo set_value('cliente_telefone'); ?>">
                    ...
                    <fieldset class="mt-4 border p-4">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-3 mb-2">
                                <label>CEP</label>
                                <input type="text" class="form-control form-control-user cep" name="cliente_cep" placeholder="CEP do cliente" value="<?php echo set_value('cliente_cep'); ?>">
                                <?php echo form_error('cliente_cep', '<small class="form-text text-danger">', '</small>'); ?>
                            </div>
                            <div class="col-md-4 mb-2">
                                <label>Logradouro</label>
                                <input type="text" class="form-control form-control-user" name="cliente_endereco" placeholder="Logradouro do cliente" value="<?php echo set_value('cliente_endereco'); ?>">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input type="text" class="form-control form-control-user" name="cliente_complemento" placeholder="Complementos" value="<?php echo set_value('cliente_complemento'); ?>">
                    ...
                    <a title="Cancelar" href="<?php echo base_url('clientes'); ?>" class="btn btn-outline-danger btn-sm ml-2"><i class="fas fa-power-off"></i>&nbsp;Cancelar</a>
                </form>
            </div>
